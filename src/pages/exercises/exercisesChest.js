import pushup from "../exercisevideo/chestvideos/male-Bodyweight-push-up-front.mp4";
import benchpress from "../exercisevideo/chestvideos/male-barbell-bench-press-front.mp4";
import cablechestpress from "../exercisevideo/chestvideos/male-cable-chestpress-front.mp4";
...
export const exercisesChest = [
  ...
  { title: "Cable Chest Press", video: cablechestpress, emoji: "🦾" },
  {
    ...
    video: dumbbellInclineChestPress,
    emoji: "🏋️‍♂️",
  },
  { title: "Butterfly", video: butterFly, emoji: "🦋" },
  { title: "Chest Press", video: chestPress, emoji: "💥" },
];
